...
#define QFW_REGION_FORK  16   // token = M rows, pos = P: row 0 -> rows 1..M-1 (all stages)
#define QFW_REGION_COMMIT 17 // token = source row r, pos = P: row r -> row 0 (all stages) - decision/commit loop
