#!/usr/bin/env bash
# reproduce_spark_tests.sh — build and run the RNG and Dumitrescu unit tests from
# the public stoch/ tree. Expected: RNG_TEST: ALL PASS; DUMI_TEST: ALL PASS.
# Requirements: CUDA >= 12 (nvcc), GPU >= sm_70.
set -euo pipefail
cd "$(dirname "$0")/.."
